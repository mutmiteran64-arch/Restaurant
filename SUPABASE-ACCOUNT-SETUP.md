...
Le compte principal et les comptes du personnel sont créés côté serveur avec `email_confirm: true`. L'application ne dépend donc pas d'un lien de confirmation envoyé par e-mail. Si une ancienne inscription avait déjà créé un compte non confirmé, la création du premier compte réutilise ce compte, le confirme côté serveur et réinitialise son mot de passe avec celui saisi dans l'application.
